;( function( $, window, undefined ) {	
    ...
    $.Calendario.defaults = {
        ...
        monthabbrs : [ 'Jan', 'Fev', 'Mar', 'Avr', 'Mai', 'Jun', 'Jul', 'Aout', 'Sep', 'Oct', 'Nov', 'Dec' ],
...
//Si j'ai un événement qui dure plusieurs jours, je place un point par jour pour le même event
//Si j'ai plusieurs events, je place juste les événements le même jour
            ...
            $(function() {
                ...
                function showEvents( $contentEl, dateProperties ) {
                    ...
                    hideEvents();					
                    var $events = $( '<div id="custom-content-reveal" class="custom-content-reveal"><h4>Événement pour le ' + dateProperties.day + ' ' + dateProperties.monthname + ', ' + dateProperties.year + '</h4></div>' ),
