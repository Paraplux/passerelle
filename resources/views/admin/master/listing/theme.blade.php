...
<div class="create-container">
    ...
    <form action="/governator/master/theme/edit" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <img id="accueil_thumb" class="theme-thumb" src="{{ $data->accueil_thumb }}" alt="">
        ...
        <div class="form-group">
            ...
            <input value="{{ $data->accueil_news_subtitle }}" type="text" name="accueil_news_subtitle" id="accueil_news_subtitle">
        </div>
        <div class="form-group">
            <label for="accueil_formations_subtitle">Sous-titre du carousel de formations : </label>
            <input value="{{ $data->accueil_formations_subtitle }}" type="text" name="accueil_formations_subtitle" id="accueil_formations_subtitle">
        </div>
        
        <h2 class="title-4">Page Se former : </h2>
        <div class="form-group">
            <label for="formations_thumb">Image de fond : </label>
            <img id="formations_thumb" class="theme-thumb" src="{{ $data->formations_thumb }}" alt="">
        ...
        <div class="form-group">
            ...
            <textarea id="theme_ckeditor_1" name="partenaires_text">{{ $data->partenaires_text }}</textarea>
        </div>

        <h2 class="title-4">Page de la cartographie : </h2>
        <div class="form-group">
            <label for="theme_ckeditor_2">Texte d'introduction : </label>
            <textarea id="theme_ckeditor_2" name="map_text">{{ $data->map_text }}</textarea>
        </div>

        <h2 class="title-4">Page contact : </h2>
        <div class="form-group">
            <label for="theme_ckeditor_3">Texte d'introduction : </label>
            <textarea id="theme_ckeditor_3" name="contact_text">{{ $data->contact_text }}</textarea>
        </div>

        <h2 class="title-4">Gestion des réseaux sociaux : </h2>
        <div class="form-group">
            <label for="fb_link">Lien de la page Facebook : </label>
            <input value="{{ $data->fb_link }}" type="text" name="fb_link" id="fb_link">
        </div>
        <div class="form-group">
            <label for="tw_link">Lien de la page Twitter : </label>
            <input value="{{ $data->tw_link }}" type="text" name="tw_link" id="tw_link">
        </div>
        <div class="form-group">
            <label for="li_link">Lien de la page LinkedIn : </label>
            <input value="{{ $data->li_link }}" type="text" name="li_link" id="li_link">
        </div>
        <div class="form-group">
            <label for="yt_link">Lien de la chaîne Youtube : </label>
            <input value="{{ $data->yt_link }}" type="text" name="yt_link" id="yt_link">
        </div>
